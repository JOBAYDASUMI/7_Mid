...
namespace Mid7_Project_01.Controllers
{
    ...
    public class TeamsController : Controller
    {
        ...
        {
            return View(db.Teams.OrderBy(x=> x.TeamId).ToPagedList(pg, 5));
        }
        ...
        {
            var p = db.Teams.FirstOrDefault(x => x.TeamId == id);
        ...
        public ActionResult Edit(int id)
        {
            ...
            var d = db.Teams.FirstOrDefault(x => x.TeamId == id);
        ...
        public ActionResult Edit(TeamEditModel model, string act = "")
        {
            ...
            {
                var index = int.Parse(act.Substring(act.IndexOf("_") + 1));
                model.TeamMembers.RemoveAt(index);
